...
const ContactUs = () => {
  return (
    ...
    <Box sx={{height: 'calc(100vh - 175px)', boxSizing: 'border-box', my: 3}}>
        <Typography align='center' variant='h4' sx={{fontWeight: 'bold', mb: 4}}>Contact Us</Typography>
        <Grid container spacing={0}>
            <Grid size='grow'>
                <img src='contactus.jpg' width='90%'  style={{ margin: 'auto'}}/>
            </Grid>
            <Grid size='grow'>
                <Box sx={{height: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start'}}>
                <Typography variant='h6' sx={{fontWeight: 'bold', mb: 3}}>Our Store</Typography>
